...
const ENGLISH: Record<string, string> = {
  ...
  打开设置: "Open settings",
  设置: "Settings",
  "点击重新安装并连接 Claude Code Hook":
    "Click to reinstall and connect the Claude Code Hook",
  "Hook 异常": "Hook issue",
  ...
  始终允许: "Always allow",
  本会话允许相同调用: "Allow the same call for this session",
  仅匹配相同工具和参数范围: "Only matches the same tool and argument scope",
  "执行并记住，之后不再询问": "Run and remember; do not ask again",
  "正在回传决定…": "Sending decision…",
  "回传失败：": "Unable to send decision: ",
  "上一条已处理，这是新的审批请求":
    "The previous request was handled; this is a new approval request",
  拒绝: "Deny",
  ...
  计划回复: "Plan reply",
  "补充修改意见；实施时留空则使用默认指令":
    "Add revision notes; leave empty when implementing to use the default instruction",
  "发送中…": "Sending…",
  "切换到 build 并发送中…": "Switching to build and sending…",
  已发送: "Sent",
  实行计划: "Run plan",
  实行计划操作: "Plan actions",
  ...
  关于: "About",
  语言: "Language",
  "选择后会立即应用到整个 CodeCraft 界面。":
    "Changes apply immediately across CodeCraft.",
  "选择界面语言，当前为简体中文":
    "Choose interface language; current language is Simplified Chinese",
  "选择界面语言，当前为繁體中文":
    "Choose interface language; current language is Traditional Chinese",
  "选择界面语言，当前为English":
    "Choose interface language; current language is English",
  界面语言: "Interface language",
  简体中文: "Simplified Chinese",
  繁體中文: "Traditional Chinese",
  通用设置内容待添加: "General settings are coming soon",
  自动清理会话: "Automatic session cleanup",
  "空闲或停止状态超过所选时间后，从会话列表中移除；工作中和等待处理的会话不会受影响。":
    "Remove idle or stopped sessions from the list after the selected time. Working sessions and sessions awaiting action are not affected.",
  清理时间: "Cleanup delay",
  "选择清理时间，当前为5 分钟":
    "Choose cleanup delay; current value is 5 minutes",
  "选择清理时间，当前为10 分钟":
    "Choose cleanup delay; current value is 10 minutes",
  "选择清理时间，当前为30 分钟":
    "Choose cleanup delay; current value is 30 minutes",
  ...
  顶部位置: "Top position",
  "控制顶部区域的水平拖拽与窗口停靠位置。":
    "Control horizontal dragging and the panel's top docking position.",
  启用顶部拖拽: "Enable top-area dragging",
  "从界面顶部拖动，在主屏顶部调整位置。":
    "Drag the top strip to reposition the panel along the top of the primary display.",
  ...
  "收到审批请求时自动展开面板。":
    "Expand the panel when an approval request arrives.",
  "Hook 管理": "Hook management",
  "点击 Agent 可安装或卸载对应的 CodeCraft Hook。":
    "Select an agent to install or remove its CodeCraft Hook.",
  ...
  亮色: "Light",
  更换跟随系统主题的工作方块图片:
    "Change the working square image for the system theme",
  更换深色主题的工作方块图片:
    "Change the working square image for the dark theme",
  更换亮色主题的工作方块图片:
    "Change the working square image for the light theme",
  "点击更换图片，显示时会自动裁切为正方形":
    "Choose another image; it is center-cropped to a square when displayed",
  选择工作方块图片: "Choose a working square image",
  "图片文件过大，请选择小于 10 MB 的文件。":
    "The image is too large. Choose a file smaller than 10 MB.",
  "请选择 PNG、SVG 或其他图片文件。":
    "Choose a PNG, SVG, or another image file.",
  "无法读取这张图片，请选择其他文件。":
    "This image could not be read. Choose another file.",
  "保存工作方块图片失败，请重试。":
    "The working square image could not be saved. Try again.",
  "工作方块图片已更新。": "The working square image has been updated.",
  透明效果: "Transparency",
  "分别调节界面、卡片和文字的透明度。":
    "Adjust panel, card, and text opacity separately.",
  界面透明度: "Panel opacity",
  卡片透明度: "Card opacity",
  文字透明度: "Text opacity",
  ...
  "控制过渡、状态动效以及内容切换动画。":
    "Control transitions, status effects, and content animations.",
  跟随系统: "System",
  开启: "On",
  关闭: "Off",
  ...
  "控制启动时长条界面的展示动画。":
    "Control how the compact bar appears at startup.",
  无: "None",
  简约动画: "Minimal",
  完整动画: "Full",
  界面设置: "Interface layout",
  "按比例缩放全部元素，或分别调整界面尺寸。":
    "Scale every element together, or tune the interface dimensions separately.",
  ...
  宽松: "Spacious",
  音效提醒: "Sound alerts",
  "在工具调用、审批和会话状态变化时播放提醒。":
    "Play alerts for tool calls, approvals, and session status changes.",
  启用音效提醒: "Enable sound alerts",
  "关闭后保留音效库与音量设置。":
    "Sound library and volume settings are kept when disabled.",
  音量调节: "Volume",
  静音: "Mute",
  音效库: "Sound library",
  "预设中的提醒类事件共用一段音效，结束类事件共用另一段。":
    "Preset alerts share one sound, while completion events share another.",
  音符盒: "Music box",
  ...
  局域网控制台: "LAN console",
  "开启后同一网络下的浏览器可以查看会话并处理审批。":
    "Let browsers on the same network view sessions and handle approvals.",
  未运行: "Stopped",
  启用服务: "Enable service",
  "首次监听时 Windows 会弹出防火墙授权，请选择“允许”。":
    "Windows will request firewall access the first time; choose Allow.",
  在线客户端: "Connected clients",
  暂无访问记录: "No access recorded",
  高级选项: "Advanced options",
  端口: "Port",
  "范围 1024–65535，被占用时会提示并保持关闭。":
    "Range 1024–65535. The service stays off if the port is in use.",
  应用: "Apply",
  访问令牌: "Access token",
  "令牌等同于密码。轮换后已登录的浏览器会立即失效。":
    "Treat the token like a password. Rotation signs out connected browsers immediately.",
  显示: "Show",
  隐藏: "Hide",
  复制: "Copy",
  轮换: "Rotate",
  ...
  "在手机浏览器里打开任一地址，然后输入访问令牌。":
    "Open any address in a mobile browser, then enter the access token.",
  "未找到局域网地址，请检查网络连接。":
    "No LAN address found. Check the network connection.",
  ...
  "局域网内是明文 HTTP，请只在可信网络中开启。":
    "LAN traffic uses plain HTTP. Enable it only on trusted networks.",
  "任何拿到地址和令牌的人都能查看会话内容。":
    "Anyone with the address and token can view session content.",
  "开启远程审批意味着对方可以代你允许工具调用。":
    "Remote approval lets other people allow tool calls for you.",
  "不使用时关闭开关，端口会立即释放。":
    "Turn the service off when unused to release the port immediately.",
  "专注于 AI 编程会话的轻量桌面工作台。":
    "A lightweight desktop workspace for AI coding sessions.",
  为编程工作流而生: "Built for coding workflows",
  "在一个安静、紧凑的界面中掌握编程助手的工作状态。":
    "Follow your coding assistants in one calm, compact interface.",
  会话集中管理: "Unified session management",
  "汇总 Claude Code 与 Codex 会话":
    "Bring Claude Code and Codex sessions together",
  关键请求及时处理: "Handle key requests quickly",
  "快速响应审批、提问与计划确认":
    "Respond to approvals, questions, and plan confirmations",
  软件更新: "Software updates",
  "检测新版本，并在更新可用时下载安装包。":
    "Check for new versions and download the installer when an update is available.",
  稳定版: "Stable",
  更新功能准备中: "Update support is coming soon",
  "稍后将支持手动检测与下载最新版本。":
    "Manual update checks and downloads will be available later.",
  软件更新操作: "Software update actions",
  ...
  "正在获取最新版本信息，请稍候…":
    "Fetching the latest version information, please wait…",
  下载中: "Downloading",
  "正在下载更新": "Downloading update",
  "正在打开下载页面，请稍候…":
    "Opening the download page, please wait…",
  无需更新: "No update needed",
  发现新版本: "Update available",
  已是最新版本: "Up to date",
  未获取到更新信息: "No update information",
  "有可用的新版本，可下载更新。":
    "A new version is available and ready to download.",
  "当前版本与最新版本一致。": "Your version is up to date.",
  "未能获取最新版本信息，可点击检查更新。":
    "Could not fetch update information. Click to check for updates.",
  ...
  "等待 Claude 产生可读取的转录输出":
    "Waiting for readable transcript output from Claude",
  ...
  "开启后同一网络中拿到地址和令牌的人都能查看会话。再次点击开关以确认开启。":
    "Anyone on the same network with the address and token can view sessions. Toggle again to confirm.",
  "轮换会立即让已登录的浏览器失效。再次点击“轮换”以确认。":
    "Rotation immediately signs out connected browsers. Select Rotate again to confirm.",
  ...
  "此问题来自外部 Codex 会话，请在原终端或 Codex 桌面任务中完成回答。":
    "This question comes from an external Codex session. Answer it in the original terminal or Codex desktop task.",
...
const toTraditional = (source: string): string => {
  ...
  return Array.from(
    translated,
    (character) => TRADITIONAL_CHARACTER_MAP[character] ?? character,
  ).join("");
};
...
const translateHookAction = (action: string, locale: AppLocale): string => {
  const isInstall =
    action === "安装" || action === "安裝" || action === "Install";
...
const formattedTranslations: FormattedTranslation[] = [
  ...
  },
  {
    ...
    format: {
      "zh-CN": (value) =>
        `筛选会话来源，当前为${translateFilterValue(value, "zh-CN")}`,
      "zh-TW": (value) =>
        `篩選會話來源，目前為${translateFilterValue(value, "zh-TW")}`,
      en: (value) =>
        `Filter session sources; current filter is ${translateFilterValue(value, "en")}`,
    },
  },
  {
    patterns: {
  ...
  },
  {
    ...
    format: {
      "zh-CN": (section) =>
        `${translateFilterValue(section, "zh-CN")}设置内容待添加`,
      "zh-TW": (section) =>
        `${translateFilterValue(section, "zh-TW")}設定內容待新增`,
      en: (section) =>
        `${translateFilterValue(section, "en")} settings are coming soon`,
    },
  },
  {
    patterns: {
  ...
  },
  {
    ...
    format: {
      "zh-CN": (action, name) =>
        `${translateHookAction(action, "zh-CN")} ${name} Hook`,
      "zh-TW": (action, name) =>
        `${translateHookAction(action, "zh-TW")} ${name} Hook`,
  ...
  },
  {
    ...
    format: {
      "zh-CN": (action, name) =>
        `点击${translateHookAction(action, "zh-CN")} ${name} Hook`,
      "zh-TW": (action, name) =>
        `點擊${translateHookAction(action, "zh-TW")} ${name} Hook`,
      en: (action, name) => `${translateHookAction(action, "en")} ${name} Hook`,
    },
  },
  {
    ...
    format: {
      "zh-CN": (action, error) =>
        `${translateHookAction(action, "zh-CN")} Hook 失败：${error}`,
      "zh-TW": (action, error) =>
        `${translateHookAction(action, "zh-TW")} Hook 失敗：${error}`,
      en: (action, error) =>
        `${translateHookAction(action, "en")} Hook failed: ${error}`,
    },
  },
  {
    patterns: {
  ...
  },
  {
    ...
    format: {
      "zh-CN": (status, title) =>
        `${translateFilterValue(status, "zh-CN")} · ${title}`,
      "zh-TW": (status, title) =>
        `${translateFilterValue(status, "zh-TW")} · ${title}`,
...
const attributeSources = new WeakMap<
  Element,
  Partial<Record<LocalizedAttribute, string>>
>();
...
const localizeAttribute = (element: Element, attribute: LocalizedAttribute) => {
  ...
  if (previousSource && current === translateText(previousSource, activeLocale))
    return;
...
const syncLanguageSelect = () => {
  const trigger =
    document.querySelector<HTMLButtonElement>("#language-trigger");
  ...
  const selected = LOCALE_OPTIONS.find(
  ...
  for (const option of options) {
    option.setAttribute(
      "aria-selected",
      String(option.dataset.locale === activeLocale),
    );
  }
};

const syncLanguageSelectWidth = (select: HTMLElement, menu: HTMLElement) => {
  const previousWidth = select.style.getPropertyValue(
    "--language-select-width",
  );
...
const initializeLanguageSelect = () => {
  ...
  const options = languageOptionButtons();
  if (!select || !trigger || !menu || options.length !== LOCALE_OPTIONS.length)
    return;
  ...
  const animateLanguageOptionToFirst = async (option: HTMLButtonElement) => {
  ...
  const openMenu = (focusIndex = 0) => {
    ...
    languageOptionButtons()[
      Math.max(0, Math.min(focusIndex, options.length - 1))
    ]?.focus({
      preventScroll: true,
    });
  };
